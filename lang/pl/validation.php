...
return [
    ...
    */
    ...
    'after_or_equal_time' => 'W przypadku gdy data rozpoczęcia i zakończenia zajęć jest taka sama :attribute nie może być godziną wcześniejszą niż :time.',
    ...
    'min' => [
        'numeric' => 'Pole :attribute nie może być mniejsze od :min (aktualnie: :count). ',
    ...
    */
    ...
    'custom' => [
        ...
        'tariff' => [
            'price' => [
                'numeric_decimal' => 'Pole :attribute musi być liczbą z dokładnością do dwóch miejsc po przecinku!'
            ]
        ]
    ],
