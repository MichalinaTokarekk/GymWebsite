<x-form-section submit="updatePassword">
    <x-slot name="title">
        {{ __('translation.profile.update_password') }}
    </x-slot>

    <x-slot name="description">
        {{ __('translation.profile.update_password_description') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('translation.profile.current_password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('translation.profile.new_password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('translation.profile.confirm_new_password') }}" />
