<div class="p-2">
    <form wire:submit.prevent="save">
     <h3 class="text-x1  leading-tight text-gray-800">
            @if ($editMode)
                {{ __('trainers.labels.edit_form_title') }}
            @else
                {{ __('trainers.labels.create_form_title') }}
            @endif
        </h3>
            ...
            <div class="grid grid-cols-2 gap-2">
                 <div class="">
                   ...
                   <div class="">
                         @if ($imageExists)
                             <div class="relative">
                                <img class="w-full" src="{{ $imageUrl }}" alt="{{ $trainer->imie }}">
