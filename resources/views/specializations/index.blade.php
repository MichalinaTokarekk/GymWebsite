        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
            <div class="bg-blue-50  overflow-hidden shadow-xl sm:rounded-lg" id="table-view-wrapper" style="padding:2cm; background-color: #ded6dc">
                <div class="grid justify-items-stretch pt-2 pr-2">
                    <x-button primary label="{{ __('specializations.actions.create') }}"
                     href="{{ route('specializations.create') }}" class="justify-self-end"
                     style="background-color: rgb(119, 57, 39)" />
                </div>

               <livewire:specializations.specializations-table-view />
            </div> 
        </div>
    </div>
</x-app-layout>
