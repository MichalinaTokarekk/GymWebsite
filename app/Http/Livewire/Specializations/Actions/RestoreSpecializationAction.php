...
class RestoreSpecializationAction extends Action
{
    public $title = '';
    public $icon = 'trash';
    ...
    {
        $view->dialog()->confirm([
            'title' => __('specializations.dialogs.restore.title'),
            'description' => __('specializations.dialogs.restore.description', [
                'name' => $model->name
            ]),
            'icon' => 'question',
